...
The Secretariat Security Force (SSF) has invited applications for **Constable (Barber) and Constable (Washerman)** posts under SSF Constable Recruitment 2026. Eligible candidates can apply online through the official recruitment portal. Check vacancy details, eligibility, age limit, salary, and selection process below.

---

## Key Highlights

- **Organization:** Secretariat Security Force (SSF)
- **Post Name:** Constable (Barber & Washerman)
- **Location:** India
- **Total Vacancies:** 10
...
| Field | Value |
|---|---|
| Post Name | Constable (Barber – 3, Washerman – 7) |
| Total Vacancies | 10 |
...
| Field | Value |
|---|---|
| Educational Qualification | 10th pass (Matriculation) from a recognized board + Trade Test |
| Experience Required | Not required |
| Age Limit | 18 to 23 years (as on 28 April 2026) |
...
- Pay Level: Level-2  
- Pay Scale: ₹19,900 – ₹63,200  
- Additional benefits: DA, HRA, Transport Allowance, LTC, Pension
...
- **Last Date to Apply:** 28 April 2026  

---

## How to Apply

Candidates can apply online through the official recruitment portal:
...
- No application correction after submission  
